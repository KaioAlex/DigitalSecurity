...
class XGBOD(BaseDetector):
    ...
    def _generate_new_features(self, X):
        ...
        for ind, estimator in enumerate(self.estimator_list):
            if self.standardization_flag_list[ind]:
                print("Predicting estimator", ind+1,"of",len(self.estimator_list),"(standarlization: true):\n", estimator)   #Debug
                print("Start: ", datetime.now())
                X_add[:, ind] = estimator.decision_function(X_norm)
                print("End: ", datetime.now(), "\n")

            else:
                print("Predicting estimator", ind+1,"of",len(self.estimator_list),"(standarlization: false):\n", estimator)   #Debug
                print("Start: ", datetime.now())
    ...
    def fit(self, X, y):
        ...
        for ind, estimator in enumerate(self.estimator_list):
            if self.standardization_flag_list[ind]:
                print("Fitting estimator", ind+1,"of",len(self.estimator_list),"(standarlization: true):\n", estimator)   #Debug
                print("Start: ", datetime.now())
                ...
                print("Fitting estimator", ind+1,"of",len(self.estimator_list),"(standarlization: false):\n", estimator)   #Debug
                print("Start: ", datetime.now())
                estimator.fit(X)
                print("End: ", datetime.now(), "\n")
                self.X_train_add_[:, ind] = estimator.decision_scores_
